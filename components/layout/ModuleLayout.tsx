...
const allModules = [
  ...
  { num: 3, title: "Working with Primitives", href: "/modules/3-working-with-primitives", time: "30 min" },
  { num: 4, title: "Operators", href: "/modules/4-operators-expressions", time: "18 min" },
  { num: 5, title: "Control Flow", href: "/modules/5-control-flow", time: "22 min" },
  { num: 6, title: "Functions & Scope", href: "/modules/6-functions-and-scope", time: "28 min" },
  { num: 7, title: "Closures & Hoisting", href: "/modules/7-closures-and-hoisting", time: "25 min" },
  { num: 8, title: "Objects & Prototypes", href: "/modules/8-objects-and-prototypes", time: "30 min" },
  { num: 9, title: "Arrays & Methods", href: "/modules/9-arrays-and-methods", time: "25 min" },
  { num: 10, title: "DOM & Events", href: "/modules/10-dom-and-events", time: "30 min" },
  { num: 11, title: "Async & Event Loop", href: "/modules/11-async-event-loop", time: "35 min" },
  { num: 12, title: "ES6+ Features", href: "/modules/12-es6-plus-features", time: "28 min" },
  { num: 13, title: "Error Handling", href: "/modules/13-error-handling", time: "20 min" },
  { num: 14, title: "JS Under the Hood", href: "/modules/14-js-under-the-hood", time: "25 min" },
  { num: 15, title: "Best Coding Practices", href: "/modules/15-best-practices", time: "40 min" },
];
